...
<body> 
    ...
    <div class="row">
        ...
        <div class="main">
            <h1>you really thought someone would write about it? </h1>
              <div class="content">
              <a>seriously, go after a shrink, its important and you are certainly in need of it <br><br> im not kidding, go now <br><br><br><br>go, why r u still in here <br><br><br><br><br><br><br><br><br><br><br><br>bye</a>
              </div>
        </div>
    </div>
    <div class="footer">
